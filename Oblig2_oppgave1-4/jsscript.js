...
let todocards = [{title:"Title", description: "Description", author:"Author"},
{title:"Title", description: "Description", author:"Author"},
{title:"Title", description: "Description", author:"Author"}];

let finishedTodocards = [{title:"Title", description: "Description", author:"Author", timestamp: new Date().toLocaleDateString()},
{title:"Title", description: "Description", author:"Author", timestamp: new Date().toLocaleDateString()},
{title:"Title", description: "Description", author:"Author", timestamp: new Date().toLocaleDateString()}];
...
function start() {
    ...
    form.addEventListener("submit", (e) => {
        ...
        let todoObject = {title : document.getElementById("title").value, description: document.getElementById("description").value, author: document.getElementById("author").value};
...
function updateCards() {
    ...
    for(i = 0; i < 3; i++) {
        let todoObject = todocards[i];

        let htmlCard = "<section class='todocard'>" +
        "<h3 class='todocardHeader'> " + todoObject.title + " </h3>" +
...
function updateCompletedList() {
    const completedListContainer = document.getElementById("completedListContainer");
    completedListContainer.innerHTML = "";

    for(i = 0; i < 3; i++) {
        const listElement = finishedTodocards[i];

        let htmlListElement = "<li>" +
                               "<h4>" + listElement.title + "</h4>" +
